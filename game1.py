...
def phoneclick():
    for i in range(15):
       if questionArea.get(1.0,'end-1c')==question[i]:
          ...
          mixer.music.play(-1)
"""
def start(current_user, function_name):
    if function_name == "lifeline50":
        lifeline50()
    elif function_name == "audiencePoleLifeLine":
        audiencePoleLifeLine()
    elif function_name == "phoneLifeLine":
        phoneLifeLine()
    elif function_name == "phoneclick":
        phoneclick()
    else:
