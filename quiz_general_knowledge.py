...
class QuizGeneralKnowledge:
    ...
    def start_quiz(self):
       ...
       print("Starting General Knowledge Quiz 8")
"""
    ...
    for i in range(15):
        if value==correct_answers[i]:
            if value==correct_answers[14]:
               ...
               # happyimage=PhotoImage(file="happy.png")
                #happyLabel2=Label(root2,image=happyimage,bg="black")
...
if __name__ == "__main__":
    # Instantiate the QuizGeneralKnowledge class and start the quiz
    quiz = QuizGeneralKnowledge()
    quiz.start_quiz()
